...
public class MainCanvases : MonoBehaviour
{
    ...
    public static MainCanvases MainInstance
    {
        get
        {
            if (mainInstance == null)
            {
                ...
                if (canvas != null)
                {
                    mainInstance = canvas.GetComponent<MainCanvases>();
                    if (mainInstance == null)
                        mainInstance = canvas.AddComponent<MainCanvases>();
                }
            }
            return mainInstance;
        }
    ...
    public static MainCanvases DialogsInstance
    {
        get
        {
            ...
            {
                var canvas = GameObject.FindWithTag("DialogsCanvas");
                if (canvas != null)
                {
                    dialogsInstance = canvas.GetComponent<MainCanvases>();
                    if (dialogsInstance == null)
                        dialogsInstance = canvas.AddComponent<MainCanvases>();
                }
            }
